...
(async()=>{
  ...
  check('Thread survives switch + adds language notice', d.getElementById('thread').children.length===beforeCount+1 && d.documentElement.dir==='rtl', beforeCount+' turns kept, notice added');
